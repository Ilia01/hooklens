  ...
  <div>
    ...
    <section class="home-codes" aria-labelledby="home-codes-title">
      <div class="home-codes-header">
        ...
        <h2 id="home-codes-title" class="section-heading">What the output actually means.</h2>
        <p>
    ...
    <section class="home-workflow" aria-labelledby="home-workflow-title">
      ...
      <h2 id="home-workflow-title" class="section-heading">Three commands. That's the whole loop.</h2>
    ...
    <section class="home-not" aria-labelledby="home-not-title">
      ...
      <div class="home-not-copy">
        <h2 id="home-not-title" class="section-heading">What HookLens is not.</h2>
        <p>
    ...
    <section class="home-guides" aria-labelledby="home-guides-title">
      ...
      <h2 id="home-guides-title" class="section-heading">Start from the provider that failed.</h2>
    ...
    <section class="home-docs" aria-labelledby="home-docs-title">
      ...
      <h2 id="home-docs-title" class="section-heading">Everything else.</h2>
    ...
    <section class="home-feedback" aria-labelledby="home-feedback-title">
      ...
      <h2 id="home-feedback-title" class="section-heading">Tell me where HookLens failed you.</h2>
